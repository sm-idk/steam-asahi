...
- **Deletes bundled Steam runtime libraries** from `~/.local/share/Steam/` that conflict with FEX emulation
...
| **FEX-Emu** | 2603 | [FEX-Emu/FEX](https://github.com/FEX-Emu/FEX) |
| **Steam bootstrap** | 1.0.0.81 | [repo.steampowered.com](https://repo.steampowered.com/steam/archive/stable/) |

All packages are built as overlays on top of nixpkgs 25.11.

## Usage

```sh
nix develop # And then use the components provided by the flake like the `asahi-steam` script
```
